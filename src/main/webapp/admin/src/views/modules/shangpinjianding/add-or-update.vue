        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="朝代" prop="chaodai">
          <el-input v-model="ruleForm.chaodai" 
              placeholder="朝代" clearable  :readonly="ro.chaodai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="朝代" prop="chaodai">
              <el-input v-model="ruleForm.chaodai" 
                placeholder="朝代" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='chaodai'){
            this.ruleForm.chaodai = obj[o];
	    this.ro.chaodai = true;
            continue;
          }
	            	            if(o=='nianfen'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shangpinjianding/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangpinjiandingCrossAddOrUpdateFlag = false;
                  this.parent.search();
