  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="地区" prop="diqu">
              <el-input v-model="ruleForm.diqu" 
                placeholder="地区" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="商铺名称" prop="shangpumingcheng">
          <el-select  @change="shangpumingchengChange" v-model="ruleForm.shangpumingcheng" placeholder="请选择商铺名称">
            <el-option
                v-for="(item,index) in shangpumingchengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.shangpumingcheng" label="商铺名称" prop="shangpumingcheng">
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                                                ...
                                                                                                                this.$http({
              url: `option/shangpuxinxi/shangpumingcheng`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.shangpumingchengOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
                                                            ...
                                                            // 下二随
    shangpumingchengChange () {
      this.$http({
        url: `follow/shangpuxinxi/shangpumingcheng?columnValue=`+ this.ruleForm.shangpumingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
